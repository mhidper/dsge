...
if T_flag
    T = usmodel.static_resid_tt(T, y, x, params);
end
residual = zeros(40, 1);
lhs = y(32);
...
residual(4) = lhs - rhs;
lhs = y(15);
rhs = T(2)*(y(15)+y(15)*params(44)*params(42)+1/T(4)*y(13))+y(35);
residual(5) = lhs - rhs;
lhs = y(13);
rhs = y(33)*1/T(6)-y(19)+y(11)*params(47)/(params(47)+1-params(13))+y(13)*T(7);
residual(6) = lhs - rhs;
lhs = y(14);
...
residual(10) = lhs - rhs;
lhs = y(39);
rhs = y(39)*(1-params(49))+y(15)*params(49)+y(35)*T(4)*params(49);
residual(11) = lhs - rhs;
lhs = y(20);
...
residual(15) = lhs - rhs;
lhs = y(26);
rhs = y(35)+T(2)*(y(26)+params(44)*params(42)*y(26)+1/T(4)*y(24));
residual(16) = lhs - rhs;
lhs = y(24);
rhs = y(33)*1/T(6)+y(29)-y(31)+params(47)/(params(47)+1-params(13))*y(22)+T(7)*y(24);
residual(17) = lhs - rhs;
lhs = y(25);
...
residual(20) = lhs - rhs;
lhs = y(29);
rhs = T(8)*(params(44)*params(42)*y(29)+y(29)*params(21)+y(20)*T(9))+y(37);
residual(21) = lhs - rhs;
lhs = y(30);
rhs = T(2)*y(30)+y(30)*T(10)+y(29)*params(19)/(1+params(44)*params(42))-y(29)*(1+params(44)*params(42)*params(19))/(1+params(44)*params(42))+y(29)*T(10)+T(11)*(params(23)*y(28)+1/(1-T(5))*y(25)-T(5)/(1-T(5))*y(25)-y(30))+y(38);
residual(22) = lhs - rhs;
lhs = y(31);
...
residual(32) = lhs - rhs;
lhs = y(40);
rhs = (1-params(49))*y(40)+params(49)*y(26)+y(35)*params(12)*T(3)*params(49);
residual(33) = lhs - rhs;
lhs = y(4);
rhs = params(39);
residual(34) = lhs - rhs;
