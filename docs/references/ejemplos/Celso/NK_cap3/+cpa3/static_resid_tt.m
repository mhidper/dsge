...
T(4) = (T(1)/(T(1)-T(2)*params(5)*params(3)))^(params(1)/(params(1)+params(2)))*(T(3)*(T(3)/(T(2)*(1-params(3))))^params(2))^(1/(params(1)+params(2)));
T(5) = params(5)*T(2)*params(3)*T(4)/T(1);
T(6) = (1-params(4)*params(8))*(1-params(8))/params(8);
