...
steady;
%mh_replic=1000
estimation(datafile=data_nueva_MEP_reducida,mode_file=MSEP_mode,nobs=71,prefilter=0,mh_jscale=0.25,mode_compute=1, tex, mh_replic=1000,nodisplay, smoother);
